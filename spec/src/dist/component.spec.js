...
describe("Component with no shadow DOM", () => {
    ...
    window.customElements.define("test-no-shadow-dom-component", TestNoShadowDOMComponent);
    let testComponent;
    beforeAll(() => {
...
describe("Custom HTML component", () => {
    ...
    window.customElements.define("test-custom-html-component", TestCustomHTMLComponent);
    let testComponent;
    beforeAll(() => {
        Component["savedTemplates"] = new Map();
        Component["savedStyles"] = new Map();
...
describe("Custom HTML component with bad selector", () => {
    ...
    window.customElements.define("test-bad-custom-html-component", TestBadCustomHTMLComponent);
    let testComponent;
    beforeAll(() => {
        Component["savedTemplates"] = new Map();
        Component["savedStyles"] = new Map();
...
describe("Component", () => {
    ...
    it("should finish fetching all files in the connectedCallback", async () => {
        ...
        expect(sheets.map((sheet) => sheet.cssRules.item(0)?.cssText)).toEqual(globalStyleSheets
    ...
    it("should have called fetch once for each file", async () => {
        ...
        expect(window.fetch).toHaveBeenCalledTimes(1 + globalStyleSheets.length + styleSheets.length);
    });
...
describe("Component with bad files", () => {
    ...
    it("should have an empty stylesheet for bad files", async () => {
        ...
        expect(sheets.length).toBe(styleSheets.length + globalStyleSheets.length + 1);
        const badStyleSheet = await Component["savedStyles"].get("/not-found.css");
